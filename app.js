...
function renderKPIs(data) {
  ...
  <p>• <strong>CPA Líquido:</strong> Com CPA Líquido de ${fmtMoney(cpaLiquido)}, ${cpaLiquido>300?"o custo está elevado. Revisar canais de menor CAC ou melhorar o CR.":"o investimento está rendendo aquisições a custo razoável."}</p>
  <p>• <strong>PDI Líquido:</strong> ${pdiLiquido<=0.095?"O Payback de Investimento está saudável.":"⚠️ PDI acima de 9.5% — revisar mix de canais ou otimizar CR."}</p>`;
}
